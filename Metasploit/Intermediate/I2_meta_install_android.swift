            ...
            VStack(spacing: 0) {
                ScrollView {
                    VStack(alignment: .leading, spacing: 15) {
                        ...
                        Text3(title1: a3, title2: a4, title3: a5)
                        
                        Text3(title1: a6, title2: a7, title3: a8)
                        
                        Text4(title1: a9, title2: a10, title3: a11, title4: a13)
                        
                        Text3(title1: a15, title2: a16, title3: a18)
                        
                        Text3(title1: a20, title2: a22, title3: a24)
                        
                        Text3(title1: a26, title2: a28, title3: a30)
                        
                        Text7(title1: a32, title2: a33, title3: a35,title4: a36, title5: a37, title6: a38, title7: a39)
                        
                      
                        Text3(title1: a41, title2: a42, title3: a44)
